...
⚠️ Note: This plugin works only with team libraries. Which means you need publish your library before you can swap styles.

⚠️ Note: The plugin swaps only color styles.
